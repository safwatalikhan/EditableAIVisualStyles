    ...
    function predict(tree, item) {
        ...
        while(true) {
            ...
            if (tree.category) {
                ...
                res += tree.attribute + " should be " + tree.category+"<br>";
                return res;
            }
            ...
            if(attr === "fontsize"){
                ...
                res += "The font size of the text is "+presc+" "+pivot;
            }
            else if(attr === "top"){
                if(value<255){
                    res += "The text is close to the top of the slide";
                }
                else if(value>=255 && value<275){
                    res += "The text is near the center of the slide (height-wise)";
                }
                else{
                    res += "The text is close to the bottom of the slide";
                };
            }
            else if(attr === "left"){
                if(value<325){
                    res += "The text is close to the left side of the slide";
                }
                else if(value>=325 && value<375){
                    res += "The text is near the center of the slide (width-wise)";
                }
                else{
                    res += "The text is close to the right side of the slide";
                }
            }
            else if(attr === "height"){
                if(value<100){
                    res += "The text box has a small height (< 100 pixels)";
                }
                else if (value<200){
                    res += "The text box has an average height";
                }
                else{
                    res += "The text box has a large height (>200 pixels)"
                }
            }
            else if(attr === "width"){
                if(value<100){
                    res += "The text box has a small width (<100 pixels)";
                }
                else if(value<320){
                    res += "The text box has an average width";
                }
                else{
                    res += "The text box has a large width (>320 pixels)";
                }
            }
            else{
                res += attr+" is "+value;
            ...
            res += "<br>";
            // if(attr==="height"||attr==="width"||attr==="top"||attr==="left"||attr==="fontsize"){
            //     if(value>=pivot){
            //         presc = ">=";
            //     }
            //     else{
            //         presc = "<"
            //     }
            //     res += attr+" "+presc+" "+pivot+"\n|\n";
            //     Logger.log(value);
            // }
            // else{
            //     res += attr+" is "+value+"\n|\n";
            // }
            // res += attr+" "+value+" "+presc+" "+pivot+"\n\n\n";
